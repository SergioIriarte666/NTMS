...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'hidden shrink-0 border-r border-black/10 bg-white/60 backdrop-blur dark:border-white/10 dark:bg-zinc-950/60 md:block',
        collapsed ? 'w-16' : 'w-64',
      )}
    >
      <div className="flex h-16 items-center gap-3 px-4">
        ...
        {!collapsed && (
          <div className="min-w-0">
            ...
            <div className="truncate text-xs text-zinc-600 dark:text-zinc-400">Empresa de grúas</div>
          </div>
        )}
      </div>
